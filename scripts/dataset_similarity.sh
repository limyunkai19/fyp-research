...
for d in 0 1 2; do
    ...
    exp=dataset_similarity_${dataset[$d]}_${model}_0,dataset_similarity_${dataset[$d]}_${model}_2,dataset_similarity_${dataset[$d]}_${model}_4
    python plot_graph.py $exp "pretrained: 0,pretrained: 2,pretrained: 4" "$model on ${dataset[$d]} dataset with data augmentation"
