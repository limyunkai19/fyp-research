...
for model in alexnet vgg16_bn densenet121 resnet50; do
    ...
    do
        python -u experiment.py $model $i $dataset layer_transferred_${dataset}_${model}_${i} --batch-size 128 --epochs 20 --data-augmentation &> layer_transferred_${dataset}_${model}_${i}
