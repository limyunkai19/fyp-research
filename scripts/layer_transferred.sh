...
for model in alexnet vgg16_bn densenet121 resnet50; do
    ...
    exp=layer_transferred_${dataset}_${model}_-1,layer_transferred_${dataset}_${model}_0,layer_transferred_${dataset}_${model}_1,layer_transferred_${dataset}_${model}_2,layer_transferred_${dataset}_${model}_3,layer_transferred_${dataset}_${model}_4
